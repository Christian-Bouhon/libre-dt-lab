 ...
 * textures don't flip the lines at every pixel; callers pass
 ...
 *   lines, and the outline stroked around both circles — white over dark
 *   content, black over bright content, so the pointer stays legible
 *   everywhere.  Typically obtained from dt_draw_backbuf_contrast().
