...
if (WIN32 AND NOT BUILD_MSYS2_INSTALL)
  ...
  # LIBARCHIVE
  file(GLOB TMP_SYSTEM_RUNTIME_LIBS
    ${MINGW_PATH}/libarchive*.dll
  )
  list(APPEND CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS ${TMP_SYSTEM_RUNTIME_LIBS})

  # EXCHNDL (exception handler)
  file(GLOB TMP_SYSTEM_RUNTIME_LIBS
  ...
  # LIBHEIF
  file(GLOB TMP_SYSTEM_RUNTIME_LIBS
    ${MINGW_PATH}/libheif*.dll
  )
  list(APPEND CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS ${TMP_SYSTEM_RUNTIME_LIBS})

  # LIBGPHOTO2
  file(GLOB TMP_SYSTEM_RUNTIME_LIBS
    ${MINGW_PATH}/libgphoto2*.dll
    ${MINGW_PATH}/libgphoto2_port*.dll
  )
  list(APPEND CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS ${TMP_SYSTEM_RUNTIME_LIBS})

  # EXIV2
  file(GLOB TMP_SYSTEM_RUNTIME_LIBS
    ${MINGW_PATH}/libexiv2*.dll
  )
  list(APPEND CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS ${TMP_SYSTEM_RUNTIME_LIBS})

  # ICU
  file(GLOB TMP_SYSTEM_RUNTIME_LIBS
    ${MINGW_PATH}/libicu*.dll
  )
  list(APPEND CMAKE_INSTALL_SYSTEM_RUNTIME_LIBS ${TMP_SYSTEM_RUNTIME_LIBS})
